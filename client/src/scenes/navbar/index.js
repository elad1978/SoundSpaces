...
const Navbar = () => {
  ...
  return (
    ...
    and use it as a component property (it works only wit the MUI Box component)*/
    <FlexBetween padding="1rem 6%" backgroundColor={alt}>
      <FlexBetween gap="1.75rem">
        {/* the clamp is a css function that aloes you to set the css property 
        what it will be:(min-value,preferred-value,max-value) */}
        <Typography
          fontWeight="bold"
